...
public class RegexDateTime{
  public static void main(String[] args)throws IOException{
    ...
    System.out.println("Input filename (dates): ");
    ...
    System.out.println("Input filename (times): ");
    String filename1 = in.nextLine();
    Scanner fin1 = new Scanner(new File(filename1));
    ArrayList<String> phonelist = new ArrayList<String>();
    int count1 = 0;
    Pattern pattern1 = Pattern.compile("[0-9]{2}( | |-)?[0-9]{3}-?[0-9]{4}");
    ...
    System.out.println("Input filename (date/times): ");
